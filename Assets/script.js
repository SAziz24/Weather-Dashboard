...
let temperatureCurrent = $('#current-temp');
...
function getCityWeather(userCity) {
    ...
    fetch("https://api.openweathermap.org/data/2.5/weather?q="+ userCity +"&appid=e022eb7a75f65c69010ab316b07fb2a3")
        ...
        .then(function (data) {
            ...
            //Create URL variable with correct long + Lagitude to fetch 5 day forecast.
            
            var  Weeklyforecast = "https://api.openweathermap.org/data/2.5/onecall?lat="+latitude+"&lon="+longitude+"&cnt=5&appid=e022eb7a75f65c69010ab316b07fb2a3"
            ...
            fetch(Weeklyforecast)
                ...
                .then(function (data) {
                    ...
                    let currTemp = (data.current.temp *1.8 - 459.67).toFixed(2);
                    ...
                    temperatureCurrent.text("  " + currTemp + " °F");
                    ...
                    for(i=0; i<5; i++) {
                        ...
                        let dailyTemp = (daily[i].temp.day *1.8 - 459.67).toFixed(2);
